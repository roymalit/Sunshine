package com.example.royma.sunshine.app.sync;
...
import com.example.royma.sunshine.app.BuildConfig;
import com.example.royma.sunshine.app.MainActivity;
import com.example.royma.sunshine.app.R;
import com.example.royma.sunshine.app.Utility;
...
public class SunshineSyncAdapter extends AbstractThreadedSyncAdapter {
    ...
    // TODO: replace with TimeUnit.DAYS.toMillis(1)
    ...
    long addLocation(String locationSetting, String cityName, double lat, double lon) {
        ...
        // Firstly, check if location with this city name exists in db
        ...
        if (locationCursor.moveToFirst()){
            ...
            // Then add the data, along with corresponding name of the data type,
            ...
            // Finally insert location data into the db
